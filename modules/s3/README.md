...
| <a name="input_prevent_destroy"></a> [prevent\_destroy](#input\_prevent\_destroy) | prevent destruction of the s3 bucket with the prevent\_destroy flag | `bool` | `true` | no |

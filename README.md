...
module "my-multi-container-service" {
  source                    = "git@github.com:in4it/terraform-modules.git//modules/ecs-service-multicontainer"
  vpc_id                    = "vpc-id"
  cluster_arn               = "cluster-arn"
  execution_role_arn        = "role-arn"
  task_role_arn             = "task-role-arn"
  aws_region                = "eu-west-1"
  healthcheck_matcher       = "200,401"
  healthcheck_path          = "/"
  cpu_reservation           = "256"
  memory_reservation        = "512"
  log_group                 = "my-multi-container-service"
  desired_count             = 1
  alb_arn                   = "alb-arn"
  launch_type               = "FARGATE"
  platform_version          = "1.4.0"
  fargate_service_subnetids = ["private-subnet"]
  deployment_controller     = "CODE_DEPLOY"
  enable_blue_green         = true
  exposed_port              = 80
  service_name              = "myservice-php"
  exposed_container_name    = "nginx"
  ingress_rules = [
    {
      from_port       = 80
      to_port         = 80
      protocol        = "tcp"
      security_groups = ["sec-group-id"]
    }
  ]
  containers = [
    {
